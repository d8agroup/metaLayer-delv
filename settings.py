...
INSTALLED_APPS = (
    ...
    'dashboard.metalayercore.dashboards',
    'dashboard.metalayercore.datapoints',
    'dashboard.emails',
    'dashboard.imaging',
    'dashboard.metalayercore.outputs',
    'dashboard.metalayercore.search',
    'dashboard.thecommunity',
    'dashboard.userprofiles',
    'dashboard.thedashboard',
    'dashboard.metalayercore.visualizations',
